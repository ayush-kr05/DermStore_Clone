...
export const ProductOverview = () => {
  ...
  return (
    ...
    <Navbar/>
     <div>
        <div className="pd1">
          <p className="pd2">Home / Skincare / {data.item_category} / {data.name}</p>
        </div>

        <div className="pd3">
          <div>
          <ProductImages img1={data.img_url_1} img2={data.img_url_2} img3={data.img_url_3}/>
          
          </div>
          <div className="productDetailDiv">
            <div className="logoImgDiv"><img src={data.brand_logo_url} alt="" /></div>
            <div className="nameDiv"><p>{data.name}</p></div>
            <div className="descriptionDiv"><p>{data.description}</p></div>
            ...
            <div className="rateOptionsDiv">
                <FormControl>
                 <FormLabel id="demo-radio-buttons-group-label"></FormLabel>
                  ...
                  >
                    <div id="rateOption">
                    <FormControlLabel value={data.mrp} control={<Radio />} label={"$"+data.mrp+"    (One Time Purchase)"} />
                    </div>
                    <div id="rateOption">
                    <FormControlLabel value={data.offer_price} control={<Radio />} label={"$"+data.offer_price+"    (Auto-Replenish)"} />
                    </div>
                  </RadioGroup>
               </FormControl>
            </div>
            ...
            <div className="deliverInstructionDiv">
                ...
                <p>Free delivery is available on all orders over $50. Please see our shipping information page for all available delivery options.</p>
